        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {subjects.map((subject) => (
            <Link
              ...
              className="rounded-xl border border-[var(--bg-border)] bg-[var(--bg-surface)] p-6 transition-all duration-200 ease-out hover:border-[var(--accent)]/30 hover:bg-[var(--bg-overlay)] hover:shadow-[0_0_24px_rgba(99,102,241,0.08)] cursor-pointer no-underline"
            >
